...
public class TableStat implements ProtoObject<TableStatProto>, Cloneable {
    ...
    public boolean equals(Object obj) {
        if (obj instanceof TableStat) {
            ...
            return this.numRows.equals(other.numRows) && this.numBytes.equals(other.numBytes) && this.numBlocks.equals(other.numBlocks)
                && this.numPartitions.equals(other.numPartitions) && this.avgRows.equals(other.avgRows)
