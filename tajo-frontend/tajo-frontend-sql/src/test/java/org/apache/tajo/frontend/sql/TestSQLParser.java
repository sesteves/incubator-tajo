...
public class TestSQLParser {
  ...
  static final String[] selectQuery = { "select id, name, age, gender from people", // 0
  ...
  static final String[] insertQueries = { "insert into people values (1, 'hyunsik', 32)",
  ...
  private final String groupbyQuery[] = { "select col0, col1, col2, col3, sum(col4) as total, avg(col5) from base group by col0, cube (col1, col2), rollup(col3) having total > 100.0" };
  ...
  public void testColumnFamily() {
    ...
    assertEquals(SQLParser.FIELD_NAME, ast.getChild(1).getChild(0).getChild(0).getType());
  ...
  private void assertSetListofSetQualifierTest(Tree ast) {
    ...
    assertEquals(SQLParser.FIELD_NAME, ast.getChild(2).getChild(0).getChild(0).getType());
  }
  ...
  static String[] joinQueries = {
      ...
      "select * from table1 " + "cross join table2 " + "join table3 on table1.id = table3.id "
          + "inner join table4 on table1.id = table4.id " + "left outer join table5 on table1.id = table5.id "
          + "right outer join table6 on table1.id = table6.id " + "full outer join table7 on table1.id = table7.id "
          + "natural join table8 " + "natural inner join table9 " + "natural left outer join table10 "
          + "natural right outer join table11 " + "natural full outer join table12 ",
      ...
      "select s_acctbal, s_name, n_name, p_partkey, p_mfgr, s_address, s_phone, s_comment, ps_supplycost "
          ...
          + "join supplier on s_nationekey = n_nationkey " + "join partsupp on s_suppkey = ps_ps_suppkey "
  ...
  public void testInnerJoinClause() {
    ...
    /**
     * from / \ TABLE join / / \ people TABLE using / / \ student FIELD_NAME
     * FIELD_NAME / \ id name
     */
  ...
  private final static String setQueries[] = { "select a,b,c from table1 union select a,b,c from table1", // 0
  ...
  static String[] ddlStatements = { "drop table abc", "create table name as select * from test",
  ...
  static String[] expressions = { "1 + 2", // 0
      "3 - 4", // 1
      "5 * 6", // 2
      "7 / 8", // 3
      "10 % 2", // 4
  ...
  static String[] arithmeticExprs = { "1 + 2", // 0
      "3 - 4", // 1
      "5 * 6", // 2
      "7 / 8", // 3
      "10 % 2", // 4
  ...
  static String[] comparisonExpr = { "1 * 2 > 3 / 4", // 5
      "1 * 2 < 3 / 4", // 6
      "1 * 2 = 3 / 4", // 7
      "1 * 2 != 3 / 4", // 8
      "1 * 2 <> 3 / 4", // 9
  ...
  public static String[] caseStatements = { "select " + "case "
      + "when p_type like 'PROMO%' then l_extendedprice * (1 - l_discount) "
      + "when p_type = 'MOCC' then l_extendedprice - 100 " + "else 0 end " + "as cond " + "from lineitem" };
  ...
  public static String[] tableSubQueries = { "select c1, c2, c3 from (select c1, c2, c3 from employee) as test",
